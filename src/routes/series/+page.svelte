...
<main class="mx-auto max-w-7xl px-3 sm:px-4 py-4 space-y-4">
  ...
  <section class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
    <form class="flex items-center gap-2 w-full sm:w-auto" method="GET" action="/series">
      <Input class="w-full sm:w-72" placeholder="Rechercher une série..." name="q" bind:value={query} />
