; Script Inno Setup pour Jellyfish
...
; Décommentez la ligne suivante pour exécuter en mode non administratif (installation pour l'utilisateur actuel uniquement.)
;PrivilegesRequired=lowest
PrivilegesRequiredOverridesAllowed=dialog
OutputDir=..\build\windows\installer
OutputBaseFilename=JellyfishSetup-{#MyAppVersion}
